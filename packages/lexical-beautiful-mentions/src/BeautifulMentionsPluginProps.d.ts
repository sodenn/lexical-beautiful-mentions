...
export interface BeautifulMentionsMenuProps extends DetailedHTMLProps<any, any> {
    /**
...
export interface BeautifulMentionsMenuItemProps extends DetailedHTMLProps<any, any> {
    /**
...
export {};
//# sourceMappingURL=BeautifulMentionsPluginProps.d.ts.map